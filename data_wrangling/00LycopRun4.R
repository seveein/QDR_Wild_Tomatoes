...
data_0 <- read.csv("/mnt/PHYTOP/SEVERIN/navautron/2023_05_23/0/slopes_1.txt", sep="\t", header=F)

data_0 <- data_0 %>% 
  mutate(Box = 1)

data_2 <- read.csv("/mnt/PHYTOP/SEVERIN/navautron/2023_05_23/2/slopes_1.txt", sep="\t", header=F)

data_2 <- data_2 %>% 
  mutate(Box = 2)

data_4 <- read.csv("/mnt/PHYTOP/SEVERIN/navautron/2023_05_23/4/slopes_1.txt", sep="\t", header=F)
...
id <- read.csv2("/mnt/PHYTOP/SEVERIN/navautron/2023_05_23/layout_scheme.csv", header=T)
...
write.csv(data_merge_id, "/home/se_residevo/Desktop/SEVERIN LAB/ResiDEvo/data/2023_ScleroPhenotypes/2023_06_14_slycop_sclero_ann_rep4.csv")
...
ggsave("Desktop/SEVERIN LAB/ResiDEvo/figures/2023_SolanumScleroReps/slycopersicoides/2023_06_14slycopersicoides_rep4.png", p_tot, dpi=600,
...
data_0 <- read.csv("/mnt/PHYTOP/SEVERIN/navautron/2023_05_23/0/counts1.txt", sep="\t", header=T)

data_0 <- data_0 %>% 
  mutate(Box = 1)

data_2 <- read.csv("/mnt/PHYTOP/SEVERIN/navautron/2023_05_23/2/counts1.txt", sep="\t", header=T)

data_2 <- data_2 %>% 
  mutate(Box = 2)

data_4 <- read.csv("/mnt/PHYTOP/SEVERIN/navautron/2023_05_23/4/counts1.txt", sep="\t", header=T)

data_4 <- data_4 %>% 
  mutate(Box = 3)

data_6 <- read.csv("/mnt/PHYTOP/SEVERIN/navautron/2023_05_23/6/counts1.txt", sep="\t", header=T)
data_6 <- data_6 %>% 
  mutate(Box = 4)
...
write.csv( data_merge_id, "/home/se_residevo/Desktop/SEVERIN LAB/ResiDEvo/data/2023_ScleroPhenotypes/lycopersicoides/2023_08_16_slycop_sclero_COUNTS_ann_wthMOCK_rep4.csv")
