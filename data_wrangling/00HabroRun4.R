...
data_0 <- read.csv("/mnt/PHYTOP/SEVERIN/navautron/2023_05_10/0/slopes_1.txt", sep="\t", header=F)
...
data_2 <- read.csv("/mnt/PHYTOP/SEVERIN/navautron/2023_05_10/2/slopes_1.txt", sep="\t", header=F)

data_2 <- data_2 %>% 
  mutate(Box = 2)

data_4 <- read.csv("/mnt/PHYTOP/SEVERIN/navautron/2023_05_10/4/slopes_1.txt", sep="\t", header=F)
...
id <- read.csv2("/mnt/PHYTOP/SEVERIN/navautron/2023_05_10/layout_scheme.csv", header=T)
...
write.csv( data_merge_id, "/home/se_residevo/Desktop/SEVERIN LAB/ResiDEvo/data/2023_ScleroPhenotypes/2023_03_24_shabro_sclero_ann_rep4.csv")
...
ggsave("/home/se_residevo/Desktop/SEVERIN LAB/ResiDEvo/figures/2023_SolanumScleroReps/2023_06_21shabro_screen4.png", p_tot, dpi=600,
       height=6, width=8, bg = "white")


##### COUNTS annotation
data_0 <- read.csv("/mnt/PHYTOP/SEVERIN/navautron/2023_05_10/0/counts1.txt", sep="\t", header=T)
...
data_2 <- read.csv("/mnt/PHYTOP/SEVERIN/navautron/2023_05_10/2/counts1.txt", sep="\t", header=T)

data_2 <- data_2 %>% 
  mutate(Box = 2)

data_4 <- read.csv("/mnt/PHYTOP/SEVERIN/navautron/2023_05_10/4/counts1.txt", sep="\t", header=T)

data_4 <- data_4 %>% 
  mutate(Box = 3)

data_6 <- read.csv("/mnt/PHYTOP/SEVERIN/navautron/2023_05_10/6/counts1.txt", sep="\t", header=T)
...
write.csv( data_merge_id, "/home/se_residevo/Desktop/SEVERIN LAB/ResiDEvo/data/2023_ScleroPhenotypes/2023_08_16_shabro_sclero_COUNTS_ann_rep4_wthMOCK.csv")
